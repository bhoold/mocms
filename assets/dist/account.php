...
<html>
  ...
  <body class="login-screen"><div class="tooltip fade top in" style="top: -99px; left: 0px; display: block;"><div class="tooltip-arrow"></div><div class="tooltip-inner">Here is the sample of talltooltip that contains three lines or more. More.</div></div>
          <?php echo form_open('',array('class' => 'login-form')); ?>
            ...
            <div class="form-group">
              <input id="login-pass" name="repassword" type="password" class="form-control login-field" placeholder="重复密码" value="<?php echo set_value('repassword'); ?>">
              <label class="login-field-icon fui-lock" for="login-pass"></label>
            </div>
            <div class="form-group">
              <input id="login-pass" name="email" type="text" class="form-control login-field" placeholder="email" value="<?php echo set_value('email'); ?>">
              <label class="login-field-icon fui-lock" for="login-pass"></label>
            </div>
