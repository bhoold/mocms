...
<head>
  ...
  <link rel="stylesheet" href="<?php echo getUrl('base')?>assets/admin/css/page-login.css">
...
<div class="layui-form-item">
	...
	<div class="layui-input-block">
		<input autofocus="autofocus" class="layui-input" <?php echo _parse_form_attributes($identity,array());?> placeholder="<?php echo lang('login_identity_label_placeholder');?>" lay-verify="required" autocomplete="off">
	</div>
</div>
<div class="layui-form-item">
